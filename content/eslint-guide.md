...
The two mechanisms that allow us to properly install and use ESLint at the
project level are:
...
You might think that we never installed `@typescript-eslint`, but it is actually
